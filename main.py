...
board_Volume = BTN((57, 165, 168), BTN_CENTER, 250 + BTNS_MIN_LINE_SPACE, BTN_WIDTH, 100 + BTN_HEIGHT,
                   text=f'{MENU_MUSIC.cur_volume}')
...
class MouseClickAnimation():
    ...
    def draw(self, surface, point_per_click, mx, my):
        ...
        if self.mouse_click_particle_condition:
            draw_text(f"+{point_per_click}", pygame.font.SysFont("Impact", 50), (132, 232, 32), surface, self.mx + 10,
                      self.my)
